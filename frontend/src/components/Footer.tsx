...
const footerLinks = {
  renters: [
    { label: 'Browse Equipment', href: '/catalog' },
    { label: 'How It Works', href: '/#how-it-works' },
    { label: 'Pricing', href: '/#pricing' },
    { label: 'FAQ', href: '/#faq' },
  ],
  owners: [
    { label: 'List Equipment', href: '/login?mode=signup' },
...
export default function Footer() {
  return (
    <footer className="bg-charcoal text-white">
      <div className="max-w-[1100px] mx-auto px-4 sm:px-6 lg:px-8 pt-12 pb-6">
        {/* Main Row */}
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8 lg:gap-12">
          ...
          <div>
            <Link to="/" className="flex items-center gap-2">
              ...
              <span className="font-serif text-xl font-semibold">AgriRent</span>
            </Link>
            <p className="mt-3 text-sm text-white/50 leading-relaxed">
              Equipment rental for modern farming. Connect, rent, and grow together.
            </p>
          </div>

          {/* For Renters */}
          <div>
            <h4 className="text-sm font-semibold mb-4">For Renters</h4>
